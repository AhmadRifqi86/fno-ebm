...
This module contains various FNO architectures for solving PDEs:
- FNO2d: Standard Fourier Neural Operator
- TransformerFNO2d: FNO with spatial transformer attention
- FourierTransformerFNO2d: FNO with transformer attention in Fourier space
- MambaFNO2d: FNO with Mamba state space models (spatial domain)
- FourierMambaFNO2d: FNO with Mamba in frequency domain
"""
...
class FNO2d(nn.Module):
    ...
    def __init__(self, modes1, modes2, width=64, num_layers=4, dropout=0.0):
        ...
        # Dropout after each Fourier layer
...
class FourierMambaFNO2d(nn.Module):
    """
...
class ChannelAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        excitation = F.silu(excitation) #original F.relu
