...
All experiments were implemented in PyTorch 2.0. Training was performed on NVIDIA A100 GPUs with mixed precision (FP16). Batch size was set to 16 for all methods. No data augmentation was used. All models were trained for 20 epochs with early stopping based on validation loss (patience = 5 epochs).