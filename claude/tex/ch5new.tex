...
While the Fourier layers provide the global receptive field necessary for operator learning, the ablation results in Table VII demonstrate that they are architecturally dependent on spatial skip connections for numerical stability. The collapse of the fourier\_only variant does not imply a lack of contribution from the spectral branch; rather, it underscores that the spectral-spatial duality is essential for the stable parameterization of the Normal-Inverse-Gamma distribution in evidential frameworks.
