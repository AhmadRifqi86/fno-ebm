...
\begin{enumerate}
    ...
    \item We investigate the validity of evidential uncertainty decomposition for neural operators and discover
    that spatially correlated uncertainty estimates correspond to regions where FNO's spectral truncation
