...
We evaluate on two benchmark PDEs from PDEBench \cite{takamoto2022pdebench} with distinct characteristics:
...
\midrule
Ensemble \cite{lakshminarayanan2017simple} & 0.00147 & -- & -- & 0.0106 & 0.758 & 0.328 & -1.784 \\
MC Dropout \cite{gal2016dropout} & 0.01005 & -- & -- & 0.0192 & 0.900 & 0.306 & -0.946 \\
\bottomrule
\end{tabular}
\end{table*}
...
We ablate key components from the Improved evidential FNO using 3500 sample as train set and 1500 sample for test set. The Baseline row refers to the full Improved model with all default components intact, serving as the reference for comparison.
