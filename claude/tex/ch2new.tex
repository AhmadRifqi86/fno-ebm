...
\draw[->, thick] (p2) -- (o2);
\draw[->, thick] (p30) -- (o30);
\node[result, below=0.8cm of p2] (mean) {Mean: $\mu = \frac{1}{T}\sum \hat{y}_t$};
\node[result, below=0.2cm of mean] (var) {Var: $\sigma^2 = \frac{1}{T}\sum (\hat{y}_t - \mu)^2$};
\draw[->, thick, dashed] (o1.south) -- ++(0,-0.2) -| (mean.north);
\draw[->, thick, dashed] (o2.south) -- ++(0,-0.2) -| (mean.north);
\draw[->, thick, dashed] (o30.south) -- ++(0,-0.2) -| (mean.north);
\end{tikzpicture}%
}
