%% Evidential Fourier Neural Operators --- manuscript source
%% NOTE: still on IEEEtran. Switch \documentclass to elsarticle once the
%% target venue (JCP / CMAME) is chosen; the \markboth and \IEEEbiography
%% blocks below are IEEE-specific and must be removed at that point.
%%
...
\author{Ahmad Rifqi~\orcidlink{0009-0000-2681-1950},~Leu Jenq-Shiou~\orcidlink{0000-0001-7197-9912},~\IEEEmembership{Senior Member,~IEEE}
\thanks{Manuscript received XX, 2026.}
\thanks{The authors are with the Department of Electrical and Computer Engineering, National Taiwan University of Science and Technology, Taipei, Taiwan.}}

% TODO(venue): \markboth names TNNLS. Update once the target journal is chosen.
\markboth{IEEE Transactions on Neural Networks and Learning Systems}%
{Rifqi and Leu: Uncertainty Quantification for Fourier Neural Operators}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{self-photo.jpeg}}]{Ahmad Rifqi}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{profleu.jpeg}}]{Jenq-Shiou Leu}
